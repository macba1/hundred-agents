 ...
 */
const SALUDO =
  '¡Hola! Soy el asistente de pedidos de Chacón Alcántara. ¿Qué necesitas?\n'
  + '1. Repetir mi último pedido\n'
  + '2. Consultar un precio\n'
  + '3. Ver ofertas\n'
  + '4. Hacer un pedido nuevo';
...
function systemPrompt(ctx) {
  ...
  return [
    ...
    'sin cambiar una palabra' + (ctx.cliente ? ' salvo el nombre de la tienda como se indica abajo' : '') + ':',
    '',
    ctx.cliente
      ? SALUDO.replace('¿Qué necesitas?', `¿Qué necesitas hoy, ${ctx.cliente.nombre}?`)
      : SALUDO,
    '',
