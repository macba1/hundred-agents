...
function paraMostrar(p) {
  return {
    ...
    // El resultado de una búsqueda NO lleva precio a propósito. El precio
    // vigente puede ser una oferta validada o un precio resuelto a mano por
    // un administrador, y eso solo lo sabe `consultas.consultarPrecio`. Si
    // el precio del PDF apareciese aquí, el modelo podría cantarlo y
    // saltarse una oferta activa.
    consultar_precio_con_la_herramienta: true,
