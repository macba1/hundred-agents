/* ============================================================
   ...
   Un solo embudo: todo prospecto nuevo entra por /diagnostico
   (clientKey "hundred") y aterriza en la MISMA base de Notion que
   el resto. No hay bases por origen; el origen es una propiedad.
   "gabi" queda congelado, funcional pero sin evolución.
...
const CLIENTS = {
  gabi: {
    key: 'gabi',
    label: 'Gabi / GAMARE',
    // CONGELADO (2026-07-31). Cumplió su función: la entrevista multi-negocio
    // para GAMARE. Se mantiene funcional para las sesiones que ya existen,
    // pero NO se evoluciona más y no se le manda ningún prospecto nuevo:
    // todo el mundo entra por /diagnostico.
    frozen: true,
    notify_notion: true,
  ...
  hundred: {
    ...
    // El único embudo de entrada vivo.
    frozen: false,
    notify_notion: true,
