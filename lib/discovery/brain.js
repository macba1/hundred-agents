...
function finalizeBrain(brain, clientKey) {
  let b = ensureDoNotSayDefaults({ ...emptyBrain(brain.client_name, clientKey), ...brain }, clientKey);
...
module.exports = {
  REQUIRED_TOP, REQUIRED_HUNDRED, REQUIRED_BY_CLIENT,
  DEFAULT_DO_NOT_SAY, DEFAULT_DO_NOT_SAY_HUNDRED,
  emptyBrain, mergePartial, getPath,
