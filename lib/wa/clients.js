...
function systemPrompt(client, opts = {}) {
  ...
  if (!opts.primerMensaje) {
    ...
    partes.push(
      ...
      'Si dice que sí, **vuelve a consultar el catálogo** para re-verificar cada ' +
      'precio (pueden haber cambiado) y sigue el flujo normal de pedido desde el ' +
      'paso de "¿algo más?". No des por hecho el pago ni la entrega: pregúntalos.\n' +
